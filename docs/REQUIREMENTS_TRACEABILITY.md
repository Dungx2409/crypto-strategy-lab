...
| Natural-language or article-link strategy authoring | Complete: prompt or public article URL, SSRF and response-size controls, separate idea and generated-source confirmation, bounded `AI_DSL@1.0`, restricted JSON, three repair attempts, deterministic 250-candle smoke test, restart-safe preview, account-owned versions, list, detail, and deletion |
